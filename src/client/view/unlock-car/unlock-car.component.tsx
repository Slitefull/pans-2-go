...
import UnlockCarFirstStep from "@/client/view/unlock-car/first-step/first-step.component";
import UnlockCarSecondStep from "@/client/view/unlock-car/second-step/second-step.component";
import RoundLoader from "@/ui-kit/components/loaders/round/round-loader.component";

import './unlock-car.styles.scss';


const UnlockCar: FC = observer((): JSX.Element => {
  ...
  return (
    <PageWrapper title="Unlock a car" withSidebar={false} withClientHeader>
      <div className="unlock-car">
